...
export default function Contact() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Remplace cette URL par ton endpoint Formspree
            const response = await fetch('https://formspree.io/f/xrbyynal', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    _subject: `Nouveau message de ${formData.name} - Service: ${formData.service}`
                }),
            });
            ...
            if (response.ok) {
                ...
                setStatusMessage("Une erreur s'est produite lors de l'envoi.");
            }
        } catch (error) {
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:w-1/2 bg-gray-50 p-8 rounded-lg shadow-md">
                        ...
                        {/* Réseaux sociaux - reste identique */}
                        <div className="mt-8">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <a href="#" className="w-10 h-10 bg-primary rounded-full flex items-center justify-center text-white hover:bg-pink-600 transition duration-300">
                    ...
                    <div className="md:w-1/2 bg-gray-50 p-8 rounded-lg shadow-md">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button 
                                type="submit" 
                                disabled={isLoading}
                                className="w-full bg-primary hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition duration-300 shadow-lg hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
