...
export default function Header() {
    ...
    <header className="bg-white shadow-md sticky top-0 z-50 fade-in">
        ...
        <nav className={`md:flex md:flex-row md:space-x-8 ${menuOpen ? 'flex flex-col space-y-4 absolute top-16 left-0 right-0 bg-white p-4 shadow-md z-50' : 'hidden md:flex'}`}>
            ...
            <a href="#equipe" className="text-gray-700 hover:text-primary font-medium transition-colors duration-300">Équipe</a>
            <Link to="/blog" className="text-gray-700 hover:text-primary font-medium transition-colors duration-300" data-testid="nav-blog">Blog</Link>
